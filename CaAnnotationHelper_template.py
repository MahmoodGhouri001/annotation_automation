...
directory = r'/home/zyclyx/Documents/sprint-16/annotation_automation/cau_sample/'
template_path = r'/home/zyclyx/Documents/sprint-16/annotation_automation/data/template/cau_temp_300_cm.jpg'
...
def processObject(filename):
    ...
    var = cv2.rectangle(img,top_left, bottom_right, 0, 2)
    cv2.imshow("test",var)
    cv2.waitKey(0)
    ...
    for item in lst:
        ...
        if object == "orign":
            print('--------orign object---------')
            # input
            org_xmin, org_ymin = top_left
            org_xmax, org_ymax = bottom_right
